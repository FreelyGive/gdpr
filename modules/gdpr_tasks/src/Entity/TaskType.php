 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/gdpr_task_type/{gdpr_task_type}",
 *     "add-form" = "/admin/structure/gdpr_task_type/add",
 *     "edit-form" = "/admin/structure/gdpr_task_type/{gdpr_task_type}/edit",
 *     "delete-form" = "/admin/structure/gdpr_task_type/{gdpr_task_type}/delete",
 *     "collection" = "/admin/structure/gdpr_task_type"
 *   }
 * )
 */
